            ...
            <div class="card">
                ...
                @else
                    <div class="card-title blue lighten-1 white-text" style="padding: 2%;">
                        Add your company's cover photo
                    </div>
                @endif
            </div>
            <div class="card">
                <div class="card-content">
                    <form method="post" action="{{url('/sp/addCover')}}" enctype="multipart/form-data">
                        {{csrf_field()}}
                        <div class="row">
                            <div class="file-field input-field">
                                ...
                                <div class="file-path-wrapper">
                                    <input class="file-path validate" type="text" placeholder="cover picture">
                                </div>
                            </div>
                        </div>
                        <div class="row">
