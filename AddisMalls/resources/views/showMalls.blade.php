                ...
                <ul class="slides">
                    <li>
                        ...
                        <div class="caption center-align" style="padding-top: 100px;">
                            <h3 style="text-shadow: 0 0 3px #03a9f4, 0 0 5px #0000FF;">List of Malls in MallAddis </h3>
        ...
        <div class="container">
            @foreach($malls as $mall)
                <div class="col s12 m4">
                    <div class="card">
                        <?php $cover = \App\Photo::where('company_id',$mall->company_id)->get();
                        ...
                        <div class="card-image item" style="text-align: center;">
                            @if($cover->count() > 0)
                                ...
                                <span class="card-title" style="text-shadow: 0 0 3px #03a9f4, 0 0 5px #0000FF; font-weight: 700;  text-transform: capitalize; top:35% ; height: 0%; text-align: center; min-width: 100%;">{{$mall->name}}</span>
